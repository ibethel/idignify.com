	<footer>
		<div class="container">
			<p><span class="legal">&copy;<?php echo date('Y'); ?> I.Dignify&nbsp;</span>Let's <strong>Free</strong> Someone Together
				<span>
					<a href="http://idignify.wordpress.com/"><img src="<?php bloginfo('template_directory'); ?>/images/posterous.png" width="23" height="23" alt="Posterous"></a>
